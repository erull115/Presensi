...
@section('content')
    ...
    <div class="page-body">
                                                ...
                                                @foreach ($cuti as $d)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @else
                                                                <a href="/admin/{{ $d->kode_izin }}/batalcuti"
        ...
        <div class="modal modal-blur fade" id="modal-pengajuancuti" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/admin/datapengajuancuti" method="POST">
                            @csrf
